    ...
    extends Gauge
{
	 ...
	 */
	protected PowerGauge(SurfaceRunner parent) {
	    super(parent);
     ...
     */
    protected final void calculatePeaks(long now, float power, float prev) {
    ...
    protected static final int METER_AVERAGE_COUNT = 112; // CB: 112 = 7 seconds
    ...
    protected char[] dbBuffer = null;
    protected char[] pkBuffer = null;
